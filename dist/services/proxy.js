...
function resolveServiceUrl(serviceType, fallbackUrl) {
...
class UsersProxy {
    _fallbackUrl;
    constructor(_fallbackUrl) {
        this._fallbackUrl = _fallbackUrl;
    }
    get baseUrl() { return resolveServiceUrl('users', this._fallbackUrl); }
    ...
    async getPreferences(userId, _token) {
        return fetchService(`${this.baseUrl}/users/${userId}/preferences`, {
            headers: { 'x-user-id': userId },
        });
    }
    async updateProfile(userId, data, _token) {
        return fetchService(`${this.baseUrl}/users/${userId}`, {
            method: 'PATCH',
    ...
    async changeUsername(userId, newUsername, password, token) {
...
class MessagesProxy {
    ...
    get baseUrl() { return resolveServiceUrl('messages', this._fallbackUrl); }
    ...
    async updateMessage(messageId, content, userId, senderContent, e2eeType) {
    ...
    async saveNotification(userId, conversationId, senderName, senderId, notificationType, channelName) {
...
class FriendsProxy {
    ...
    get baseUrl() { return resolveServiceUrl('friends', this._fallbackUrl); }
...
class CallsProxy {
    ...
    get baseUrl() { return resolveServiceUrl('calls', this._fallbackUrl); }
    internalHeaders(userId) {
        return {
    ...
    async createDmCall(data) {
        return fetchService(`${this.baseUrl}/calls/dm`, { method: 'POST', headers: this.internalHeaders(data.initiatorId), body: JSON.stringify(data) });
    }
    async createGroupCall(data) {
        return fetchService(`${this.baseUrl}/calls/group`, { method: 'POST', headers: this.internalHeaders(data.initiatorId), body: JSON.stringify(data) });
    }
    async createServerCall(data) {
        return fetchService(`${this.baseUrl}/calls/server`, { method: 'POST', headers: this.internalHeaders(data.initiatorId), body: JSON.stringify(data) });
    }
    async getCallQuality(callId) {
        return fetchService(`${this.baseUrl}/calls/${callId}/quality`, { method: 'GET', headers: this.internalHeaders() });
    }
    async getServerLimit(serverId) {
        try {
            const res = await fetchService(`${this.baseUrl}/calls/limits/${serverId}`, { method: 'GET', headers: this.internalHeaders() });
...
class MediaServerProxy {
    ...
    async get(path) {
        ...
        if (!res.ok)
            throw new Error(`media-server GET ${path}: ${res.status}`);
        return res.json();
    }
    async createRoom(callId, callCategory) {
        return this.post('/internal/rooms', { callId, callCategory });
    }
    async destroyRoom(callId) {
        return this.del(`/internal/rooms/${callId}`);
    }
    async getRtpCapabilities(callId) {
        return this.get(`/internal/rooms/${callId}/capabilities`);
    }
    async createTransport(callId, userId, direction) {
        return this.post(`/internal/rooms/${callId}/transports`, { userId, direction });
    }
    async connectTransport(callId, transportId, dtlsParameters) {
        return this.post(`/internal/rooms/${callId}/connect`, { transportId, dtlsParameters });
    }
    async produce(callId, transportId, kind, rtpParameters, userId, appData) {
        return this.post(`/internal/rooms/${callId}/produce`, {
            transportId, kind, rtpParameters, userId, appData,
        });
    }
    async consume(callId, recvTransportId, producerId, rtpCapabilities, userId) {
        return this.post(`/internal/rooms/${callId}/consume`, { recvTransportId, producerId, rtpCapabilities, userId });
    }
    async resumeConsumer(callId, consumerId) {
        return this.post(`/internal/rooms/${callId}/resume`, { consumerId });
    }
    async closeProducer(callId, producerId) {
        return this.post(`/internal/rooms/${callId}/close-producer`, { producerId });
    }
    async getRoomStats(callId) {
        return this.get(`/internal/rooms/${callId}/stats`);
    }
    async getProducers(callId) {
        return this.get(`/internal/rooms/${callId}/producers`);
    }
}
// ============ SERVERS PROXY ============
class ServersProxy {
    ...
    get baseUrl() { return resolveServiceUrl('servers', this._fallbackUrl); }
    ...
    async updateServer(serverId, updates, userId, token) {
        return fetchService(`${this.baseUrl}/servers/${serverId}`, {
            method: 'PATCH',
            headers: { 'x-user-id': userId },
    ...
    async deleteServer(serverId, userId, token) {
        return fetchService(`${this.baseUrl}/servers/${serverId}`, {
            method: 'DELETE',
            headers: { 'x-user-id': userId },
            body: JSON.stringify({ userId }),
    ...
    async createChannel(serverId, data, userId, token) {
        return fetchService(`${this.baseUrl}/servers/${serverId}/channels`, {
            method: 'POST',
            headers: { 'x-user-id': userId },
    ...
    async updateChannel(serverId, channelId, updates, userId, token) {
    ...
    async deleteChannel(serverId, channelId, userId, token) {
        return fetchService(`${this.baseUrl}/servers/${serverId}/channels/${channelId}`, {
            method: 'DELETE',
            headers: { 'x-user-id': userId },
            body: JSON.stringify({ userId }),
    ...
    async updateMember(serverId, memberUserId, data, actorId, token) {
    ...
    async createRole(serverId, data, userId) {
        return fetchService(`${this.baseUrl}/servers/${serverId}/roles`, {
            method: 'POST',
    ...
    async updateRole(serverId, roleId, data, userId) {
    ...
    async deleteRole(serverId, roleId, userId) {
        return fetchService(`${this.baseUrl}/servers/${serverId}/roles/${roleId}`, {
            method: 'DELETE',
            headers: userId ? { 'x-user-id': userId } : undefined,
        });
...
class BotsProxy {
    ...
    get baseUrl() { return resolveServiceUrl('bots', this._fallbackUrl); }
    async getBot(botId) {
