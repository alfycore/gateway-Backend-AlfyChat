...
function validateProfile(data) {
    ...
    if (hiddenBadgeIds !== undefined)
        out.hiddenBadgeIds = hiddenBadgeIds;
    return out;
}
function validateGroupInput(data) {
    ...
    if (data.isOpen !== undefined)
        out.isOpen = validateBool(data.isOpen, 'isOpen');
    return out;
}
...
function validateChannelInput(data) {
    ...
    if (data.type !== undefined) {
        if (!['text', 'voice', 'forum', 'announcement', 'stage', 'category', 'gallery', 'poll', 'suggestion', 'doc', 'counting', 'vent', 'thread', 'media', 'minigame', 'trivia'].includes(data.type))
...
function validateRoleInput(data) {
    ...
    if (data.mentionable !== undefined)
        out.mentionable = validateBool(data.mentionable, 'mentionable');
    return out;
}
