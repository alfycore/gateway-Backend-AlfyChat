...
export declare const inviteVerifyRateLimit: Map<string, number[]>;
export declare const INVITE_VERIFY_WINDOW = 60000;
export declare const INVITE_VERIFY_MAX = 20;
export declare function checkInviteVerifyRate(userId: string): boolean;
