...
exports.INVITE_VERIFY_MAX = exports.INVITE_VERIFY_WINDOW = exports.inviteVerifyRateLimit = exports.JOIN_RATE_MAX = exports.JOIN_RATE_WINDOW = exports.serverJoinRateLimit = exports.MSG_RATE_MAX = exports.MSG_RATE_WINDOW = exports.messageRateLimit = void 0;
exports.checkServerJoinRate = checkServerJoinRate;
exports.checkInviteVerifyRate = checkInviteVerifyRate;
...
exports.inviteVerifyRateLimit = new Map();
exports.INVITE_VERIFY_WINDOW = 60000; // 60 s
exports.INVITE_VERIFY_MAX = 20; // max 20 tentatives / min / user
function checkInviteVerifyRate(userId) {
    const now = Date.now();
    const timestamps = exports.inviteVerifyRateLimit.get(userId) || [];
    const recent = timestamps.filter(t => now - t < exports.INVITE_VERIFY_WINDOW);
    if (recent.length >= exports.INVITE_VERIFY_MAX)
        return false;
    recent.push(now);
    exports.inviteVerifyRateLimit.set(userId, recent);
    return true;
}
